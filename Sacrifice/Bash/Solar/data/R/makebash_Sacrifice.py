...
SCRIPT_NAME = '/home/dgooding2/BigDCTest_waterphase_2020Nov30/Sacrifice/scripts/AccFill/ND/data/AllSac_R.py'
...
for i in range(runs):
	...
	f.write('\n')
	outname = '/home/dgooding2/BigDCTest_waterphase_2020Nov30/Sacrifice/outroots/ND/data/R/out_{}.root'.format(i)
