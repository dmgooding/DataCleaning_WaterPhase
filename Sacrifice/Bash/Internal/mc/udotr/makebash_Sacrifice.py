...
runs = 760
BATCH_NAME = 'Internal'
JOB_NAME = 'Internal_mc_sac_udotr'
...
SCRIPT_NAME = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/scripts/AccFill/Internal/mc/AllSac_udotr_mc.py' 
...
for i in range(runs):
	...
	f.write('\n')
	outname = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/outroots/Internal/mc/udotr/out_{}.root'.format(i)
