...
runs = 117
BATCH_NAME = 'External'
JOB_NAME = 'External_mc_sac_udotr'
...
SCRIPT_NAME = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/scripts/AccFill/External/mc/AllSac_udotr_mc.py' 
...
for i in range(runs):
	...
	f.write('\n')
	outname = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/outroots/External/mc/udotr/out_{}.root'.format(i)
