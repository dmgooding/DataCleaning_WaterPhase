...
runs = 760
BATCH_NAME = 'IntNear'
JOB_NAME = 'IntNear_mc_sac_Energy'
DATA_PATH = '/nfs/disk0/dgooding2/new_BatchSubmission_Subtupler/NewSubs_newEcorr/N16_MC_int_subs/'
SCRIPT_PATH = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/scripts/AccFill/IntNear/mc/'
SCRIPT_NAME = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/scripts/AccFill/IntNear/mc/AllSac_Energy_mc.py' 
...
for i in range(runs):
	...
	f.write('\n')
	outname = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/outroots/IntNear/mc/Energy/out_{}.root'.format(i)
