...
runs = 144
BATCH_NAME = 'IntNear'
JOB_NAME = 'IntNear_data_sac_udotr'
...
SCRIPT_NAME = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/scripts/AccFill/IntNear/data/AllSac_udotr.py' 
...
for i in range(runs):
	...
	f.write('\n')
	outname = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/outroots/IntNear/data/udotr/out_{}.root'.format(i)
