...
runs = 117
BATCH_NAME = 'Ropes'
JOB_NAME = 'Ropes_mc_sac_Energy'
DATA_PATH = '/nfs/disk0/dgooding2/new_BatchSubmission_Subtupler/NewSubs_newEcorr/N16_MC_ext_subs/'
SCRIPT_PATH = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/scripts/AccFill/Ropes/mc/'
SCRIPT_NAME = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/scripts/AccFill/Ropes/mc/AllSac_Energy_mc.py' 
...
for i in range(runs):
	...
	f.write('\n')
	outname = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/outroots/Ropes/mc/Energy/out_{}.root'.format(i)
