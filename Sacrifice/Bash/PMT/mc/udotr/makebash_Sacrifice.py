...
SCRIPT_NAME = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/scripts/AccFill/PMT/mc/AllSac_udotr_mc.py' 
...
for i in range(runs):
	...
	f.write('\n')
	outname = '/nfs/disk2/dgooding2/Sacrifice_test/Release_1/Sacrifice/outroots/PMT/mc/udotr/out_{}.root'.format(i)
