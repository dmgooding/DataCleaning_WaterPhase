...
#DC.GetXaxis().SetRangeUser(0.21,0.99)
#DC.SetLineColor(46)
...
#CC.GetXaxis().SetRangeUser(0.21,0.99)
#CC.SetLineColor(9)
...
DC.Fit(DCfit, "RB")
DC.GetXaxis().SetRangeUser(0.4, 0.9)
DC.SetLineColor(603)
DC.GetXaxis().SetTitle("U.R")
DC.GetYaxis().SetTitle("Fractional Sacrifice")
...
CC.Fit(CCfit, "RB")
CC.GetXaxis().SetRangeUser(0.4, 0.9)
CC.SetLineColor(603)
CC.GetXaxis().SetTitle("U.R")
CC.GetYaxis().SetTitle("Fractional Sacrifice")
...
ROOT.gStyle.SetOptFit(0)
c1.Draw()
c1.SaveAs("sac_dc_ext_ur.pdf")
c1.Write()
c2.Draw()
c2.SaveAs("sac_cc_ext_ur.pdf")
c2.Write()
CC.Write()
DC.Write()
testing.Close()
