...
DC.Fit(DCfit, "RB")
DC.GetXaxis().SetRangeUser(0.05, 0.6)
DC.SetLineColor(603)
...
CC.Fit(CCfit, "RB")
CC.GetXaxis().SetRangeUser(0.05,0.6)
CC.SetLineColor(603)
...
ROOT.gStyle.SetOptFit(0)
c1.Draw()
c1.SaveAs("sac_dc_ND_r.pdf")
c1.Write()
c2.Draw()
c2.SaveAs("sac_cc_ND_r.pdf")
c2.Write()
CC.Write()
DC.Write()
testing.Close()
