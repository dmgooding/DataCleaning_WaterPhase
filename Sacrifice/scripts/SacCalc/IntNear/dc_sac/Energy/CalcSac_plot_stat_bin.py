...
DC.Fit(DCfit, "RB")
DC.GetXaxis().SetRangeUser(4.2, 4.8)
DC.SetLineColor(603)
DC.GetXaxis().SetTitle("Energy [MeV]")
DC.GetYaxis().SetTitle("Fractional Sacrifice")
...
CC.Fit(CCfit, "RB")
CC.GetXaxis().SetRangeUser(4.2, 4.8)
CC.SetLineColor(603)
CC.GetXaxis().SetTitle("Energy [MeV]")
CC.GetYaxis().SetTitle("Fractional Sacrifice")
...
ROOT.gStyle.SetOptFit(0)
c1.Draw()
c1.SaveAs("sac_dc_IntNear_e.pdf")
c1.Write()
c2.Draw()
c2.SaveAs("sac_cc_IntNear_e.pdf")
c2.Write()
CC.Write()
DC.Write()
testing.Close()
