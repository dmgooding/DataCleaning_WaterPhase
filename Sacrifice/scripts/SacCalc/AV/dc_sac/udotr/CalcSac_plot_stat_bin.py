...
DC.Fit(DCfit, "RB")
DC.GetXaxis().SetRangeUser(0.948, 0.998)
DC.SetLineColor(603)
...
CC.Fit(CCfit, "RB")
CC.GetXaxis().SetRangeUser(0.948, 0.998)
CC.SetLineColor(603)
...
ROOT.gStyle.SetOptFit(0)
c1.Draw()
c1.SaveAs("sac_dc_av_ur.pdf")
c1.Write()
c2.Draw()
c2.SaveAs("sac_cc_av_ur.pdf")
c2.Write()
CC.Write()
DC.Write()
testing.Close()
