...
DC.Fit(DCfit, "RB")
DC.GetXaxis().SetRangeUser(0.865, 1.145)
DC.SetLineColor(603)
...
CC.Fit(CCfit, "RB")
CC.GetXaxis().SetRangeUser(0.865, 1.145)
CC.SetLineColor(603)
...
ROOT.gStyle.SetOptFit(0)
c1.Draw()
c1.SaveAs("sac_dc_ropes_r.pdf")
c1.Write()
c2.Draw()
c2.SaveAs("sac_cc_ropes_r.pdf")
c2.Write()
CC.Write()
DC.Write()
testing.Close()
