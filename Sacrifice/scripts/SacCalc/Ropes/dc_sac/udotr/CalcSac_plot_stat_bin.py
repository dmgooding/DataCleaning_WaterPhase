...
DC.Fit(DCfit, "RB")
DC.GetXaxis().SetRangeUser(0.1, 0.9)
DC.SetLineColor(603)
...
CC.Fit(CCfit, "RB")
CC.GetXaxis().SetRangeUser(0.1, 0.9)
CC.SetLineColor(603)
...
ROOT.gStyle.SetOptFit(0)
c1.Draw()
c1.SaveAs("sac_dc_ropes_ur.pdf")
c1.Write()
c2.Draw()
c2.SaveAs("sac_cc_ropes_ur.pdf")
c2.Write()
CC.Write()
DC.Write()
testing.Close()
