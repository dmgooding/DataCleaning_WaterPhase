...
CC_data_fit = ROOT.TF1("CC_data_fit", "pol1(0)", 3.1, 4.9)
...
CC_data_fit.SetLineColor(809)
CC_data.Fit(CC_data_fit, "RB")
CC_data.GetXaxis().SetRangeUser(3.2, 4.8)
CC_data.SetLineColor(603)
CC_data.GetXaxis().SetTitle("Energy [MeV]")
CC_data.GetYaxis().SetTitle("Data Acceptance / MC Acceptance")
CC_data.GetYaxis().SetTitleOffset(1.2)
CC_data.SetLineWidth(2)
ROOT.gStyle.SetErrorX(0.)
ROOT.gStyle.SetOptStat(0)
ROOT.gStyle.SetOptFit(0)
CC_data.Draw("SAME HISTE1")
c1.SaveAs("cc_Internal_e.pdf")
...
f3.write("\n")
chi2 = CC_data_fit.GetChisquare()
ndf = CC_data_fit.GetNDF()
chindf = chi2/ndf
f3.write("chi2/ndf is {}".format(chindf))
#c1.Draw()
