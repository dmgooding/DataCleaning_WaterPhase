...
f3.write("\n")
f3.write("bin width: {} ev".format(float((float(last_bin)  - float(first_bin))/float(nbins - 1.0))))
f3.write("\n")
...
#DC.GetXaxis().SetRangeUser(3.1,4.9)
#DC.SetLineColor(46)
...
#CC.GetXaxis().SetRangeUser(3.1,4.9)
#CC.SetLineColor(9)
...
c1 = ROOT.TCanvas()
DC.SetTitle("Data Cleaning Cuts")
DCfit.SetLineColor(809)
DC.Fit(DCfit, "RB")
DC.GetXaxis().SetRangeUser(3.2,4.8)
DC.SetLineColor(603)
DC.GetXaxis().SetTitle("Energy [MeV]")
DC.GetYaxis().SetTitle("Fractional Sacrifice")
DC.GetYaxis().SetTitleOffset(1.2)
DC.SetLineWidth(2)
DC.Draw("SAME HISTE1")

c2 = ROOT.TCanvas()
CC.SetTitle("Classifier Cuts")
CCfit.SetLineColor(809)
CC.Fit(CCfit, "RB")
CC.GetXaxis().SetRangeUser(3.2,4.8)
CC.SetLineColor(603)
CC.GetXaxis().SetTitle("Energy [MeV]")
CC.GetYaxis().SetTitle("Fractional Sacrifice")
CC.GetYaxis().SetTitleOffset(1.2)
CC.SetLineWidth(2)
CC.Draw("HISTE1 SAME")
ROOT.TGaxis.SetMaxDigits(2)
...
ROOT.gStyle.SetOptFit(0)
c1.Draw()
c1.SaveAs("sac_dc_Internal_e.pdf")
c1.Write()
c2.Draw()
c2.SaveAs("sac_cc_Internal_e.pdf")
c2.Write()
CC.Write()
DC.Write()
testing.Close()
