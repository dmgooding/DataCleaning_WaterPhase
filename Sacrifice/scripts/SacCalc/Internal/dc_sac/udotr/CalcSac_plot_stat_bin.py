...
DC.Fit(DCfit, "RB")
DC.GetXaxis().SetRangeUser(-0.8, 0.8)
DC.SetLineColor(603)
...
CC.Fit(CCfit, "RB")
CC.GetXaxis().SetRangeUser(-0.8, 0.8)
CC.SetLineColor(603)
...
ROOT.gStyle.SetOptFit(0)
c1.Draw()
c1.SaveAs("sac_dc_Internal_ur.pdf")
c1.Write()
c2.Draw()
c2.SaveAs("sac_cc_Internal_ur.pdf")
c2.Write()
CC.Write()
DC.Write()
testing.Close()
