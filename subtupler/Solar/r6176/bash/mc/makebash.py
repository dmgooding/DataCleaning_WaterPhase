...
BATCH_NAME = 'ND_int_mc_subs'
JOB_NAME = 'ND_int_mc_subs'
DATA_PATH = '/nfs/disk0/dgooding2/FullDCPush_DataAndCalibration_Preprocessing/N16/r6176/mc/full/int/'
SCRIPT_PATH = '/nfs/disk0/dgooding2/FullDCPush_DataAndCalibration_Preprocessing/subtupler/Solar/r6176/'
SCRIPT_NAME = 'subtupleMaker_Analysis'
OUTPATH = '/nfs/disk0/dgooding2/FullDCPush_DataAndCalibration_Preprocessing/N16/r6176/mc/subtupled/int/Solar'
