...
DATA_PATH = '/nfs/disk0/dgooding2/FullDCPush_DataAndCalibration_Preprocessing/N16/r654/mc/full/int/'
...
OUTPATH = '/nfs/disk0/dgooding2/FullDCPush_DataAndCalibration_Preprocessing/N16/r654/mc/subtupled/int'
...
for i in range(runs):
	...
	f.write('./{} {} --out {}'.format(SCRIPT_NAME, datapath, outname))
	f.write('\n')
	f.close()
